...
function App() {
  ...
  const stageClass = (stage) => `absolute z-10 scale-[.55] sm:scale-75 lg:scale-100 cursor-pointer opacity-45 transition duration-300 hover:z-50 hover:scale-90 lg:hover:scale-110 hover:opacity-100 ${selectedStage === stage ? 'z-50 !opacity-100 !border-[#9f149f] shadow-[0_0_20px_rgba(159,20,159,.4),12px_12px_0_#191b23]' : ''}`
