        ...
        <div className="overflow-hidden rounded-[32px] border-[4px] border-[#191b23] bg-[#faf8ff] p-8 shadow-[8px_8px_0_#191b23] transition-transform duration-300" style={{ transform: `rotateY(${tilt.x}deg) rotateX(${tilt.y}deg)` }}>
          ...
          <div className="mt-10 flex flex-col items-center gap-4 border-t-[3px] border-[#191b23] pt-6">
            ...
            <div className="flex gap-4">
              <button type="button" aria-label="Login dengan Google" onClick={() => { window.location.href = `${import.meta.env.VITE_API_URL}/auth/google/redirect` }} className="flex items-center justify-center rounded-xl border-2 border-[#191b23] bg-white p-3 shadow-[3px_3px_0_#191b23] transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:bg-[#f3dff3] hover:shadow-[4px_4px_0_#191b23] active:translate-x-0 active:translate-y-0 active:shadow-none">
